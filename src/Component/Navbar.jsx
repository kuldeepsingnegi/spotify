  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semibold'>
        <div className=' flex items-center gap-2 '>
           <img className='w-8 bg-black rounded-2xl cursor-pointer p-2 ' src={assets.arrow_left} alt="" />
           <img className='w-8 bg-black rounded-2xl cursor-pointer p-2 ' src={assets.arrow_right} alt="" />
